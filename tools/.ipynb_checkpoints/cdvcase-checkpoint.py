...
class ToolCDVCaseLookup(BaseTool):
    ...
    description: str = "Finds the specided number of most recent support cases filed by a customer."
    ...
    def _run(self, customer: str, number: int) -> str:
...
"dataset_id":514}}""".format(logo_name=customer.lower(), number_cases=number)
